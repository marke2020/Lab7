...
/**
 * Rock, Paper, Scissor, Lizard, Spock game class
 * @author Sharmarke Farah
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     * To check if a choice is valid
     * @param pick person choice among the choices
     * @return person's choice if valid returns false
     */
     ...
     * @param c_pick computers choice
     * @param h_pick player choice
